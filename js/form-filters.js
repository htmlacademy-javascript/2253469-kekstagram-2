...
const scaleControlValue = imgUploadSection.querySelector(
...
const scaleControlSmaller = imgUploadSection.querySelector(
  '.scale__control--smaller'
);
const scaleControlBigger = imgUploadSection.querySelector(
